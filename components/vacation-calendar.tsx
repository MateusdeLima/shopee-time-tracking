            ...
            <div className="flex flex-col xl:flex-row gap-8 items-start justify-center">
              <div className="flex-1 w-full p-6 border rounded-2xl bg-white shadow-sm ring-1 ring-gray-100">
                ...
                classNames={{
                  ...
                  cell: "h-14 w-14 text-center text-lg p-0 relative [&:has([aria-selected])]:bg-orange-100 first:[&:has([aria-selected])]:rounded-l-full last:[&:has([aria-selected])]:rounded-r-full focus-within:relative focus-within:z-20",
                  day: "h-14 w-14 p-0 font-semibold aria-selected:opacity-100 rounded-full transition-all hover:bg-orange-200 active:scale-95",
                  day_today: "bg-gray-100 text-[#EE4D2D] font-bold ring-2 ring-[#EE4D2D]/20",
                  day_selected: "bg-[#111111] text-white hover:bg-[#222222] focus:bg-[#111111] shadow-md z-10",
                  day_range_start: "bg-[#111111] text-white rounded-full",
                  day_range_end: "bg-[#111111] text-white rounded-full",
                  day_range_middle: "bg-orange-100 text-orange-900 rounded-none px-0",
